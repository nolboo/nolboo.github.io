...
맥앱 목록을 터미널에서 텍스트 에디터로 리스팅하는 것만 사용했는데, 영수증이 있는 목록 등 다른 방법들도 소개한 기시가 있어서 링크한다.

* [4 Ways to Generate a List of Apps Installed on Your Mac](https://www.makeuseof.com/tag/list-installed-apps-mac/)
